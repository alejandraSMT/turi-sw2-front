    ...
    if (changeValues) {
        buttonView =
            <div class="profile-buttons">
                <button class="btn-profile btn" type="button" onClick={handleActivateChangesClick}>Actualizar datos</button>
            </div>
    } else {
        buttonView =
            <div class="profile-buttons">
                ...
                <button class="btn-profile-cancel btn" style={{ backgroundColor: (buttonSelection == 0) ? "white" : "#588a4d", color: (buttonSelection == 0) ? "black" : "white" }} type="button" onClick={handleDeactivateChangesClick} onMouseOver={() => setButtonSelection(1)}>Cancelar</button>
            </div>
    }
