  ...
  return (
    <div>
      ...
      <div class="container mt-5 mb-5">
        <h1 className='TitleScreen'>Preguntas Frecuentes</h1>
        <br />
        <div>
          {arrayPreguntas.map((pregunta,index) => (
            <div key={`${pregunta.id_pregunta}_${index}_id`} >
              <div class="accordion accordion-flush" id={`${pregunta.id_pregunta}_${index}_id`}>
                <Pregunta
                  id={`accordion-${index}`}
